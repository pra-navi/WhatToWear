...
export const getAllTops = (userId) => API.get(`/outfits/getAllTopsuserId=${userId}`); //userId is a string
export const getAllBottoms = (userId) => API.get(`/outfits/getAllBottomsuserId=${userId}`); //userId is a string
export const getAllFull = (userId) => API.get(`/outfits/getAllFull?userId=${userId}`); //userId is a string
